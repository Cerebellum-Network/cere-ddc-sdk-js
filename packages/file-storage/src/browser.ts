...
export class FileStorage implements FileStorageInterface {
    ...
    read(bucketId: bigint, cid: string, readOptions: ReadOptions = {}): ReadableStream<Uint8Array> {
    ...
    readLinks(bucketId: bigint, links: Array<Link>, readOptions: ReadOptions = {}): ReadableStream<Uint8Array> {
        return new ReadableStream<Uint8Array>(
