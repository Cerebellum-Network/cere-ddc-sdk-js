...
export interface PutMultiPartPieceRequest {
    ...
    /**
     * @generated from protobuf field: uint64 totalSize = 2;
     */
    totalSize: bigint; // size of the multi-part piece (large file total size)
    /**
     * @generated from protobuf field: uint64 partSize = 3;
     */
    partSize: bigint; // size of the raw piece (large file part size)
    /**
     * @generated from protobuf field: repeated bytes partHashes = 4;
     */
...
export interface GetFileRequest {
    ...
    /**
     * @generated from protobuf field: file.GetFileRequest.Range range = 2;
     */
...
export interface GetFileResponse {
    ...
    body: {
        oneofKind: "proof";
        /**
         * @generated from protobuf field: bytes proof = 1;
         */
        proof: Uint8Array; // first message contains only merkle proof of requested content for the root (CID)
    } | {
        oneofKind: "data";
        /**
...
class PutMultiPartPieceRequest$Type extends MessageType<PutMultiPartPieceRequest> {
    constructor() {
        super("file.PutMultiPartPieceRequest", [
            { no: 1, name: "cid", kind: "scalar", T: 12 /*ScalarType.BYTES*/ },
            { no: 2, name: "totalSize", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/ },
            { no: 3, name: "partSize", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/ },
            { no: 4, name: "partHashes", kind: "scalar", repeat: 2 /*RepeatType.UNPACKED*/, T: 12 /*ScalarType.BYTES*/ }
        ]);
    }
    create(value?: PartialMessage<PutMultiPartPieceRequest>): PutMultiPartPieceRequest {
        const message = { cid: new Uint8Array(0), totalSize: 0n, partSize: 0n, partHashes: [] };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
    ...
    internalBinaryWrite(message: PutMultiPartPieceRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* repeated bytes partHashes = 4; */
        for (let i = 0; i < message.partHashes.length; i++)
            writer.tag(4, WireType.LengthDelimited).bytes(message.partHashes[i]);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class GetFileRequest$Type extends MessageType<GetFileRequest> {
    constructor() {
        super("file.GetFileRequest", [
            { no: 1, name: "cid", kind: "scalar", T: 12 /*ScalarType.BYTES*/ },
            { no: 2, name: "range", kind: "message", T: () => GetFileRequest_Range }
        ]);
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* bytes cid */ 1:
                    message.cid = reader.bytes();
                    break;
                case /* file.GetFileRequest.Range range */ 2:
    ...
    internalBinaryWrite(message: GetFileRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.cid.length)
            writer.tag(1, WireType.LengthDelimited).bytes(message.cid);
        /* file.GetFileRequest.Range range = 2; */
        if (message.range)
            GetFileRequest_Range.internalBinaryWrite(message.range, writer.tag(2, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class GetFileResponse$Type extends MessageType<GetFileResponse> {
    constructor() {
        super("file.GetFileResponse", [
            { no: 1, name: "proof", kind: "scalar", oneof: "body", T: 12 /*ScalarType.BYTES*/ },
    ...
    internalBinaryWrite(message: GetFileResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.body.oneofKind === "proof")
            writer.tag(1, WireType.LengthDelimited).bytes(message.body.proof);
        /* bytes data = 2; */
