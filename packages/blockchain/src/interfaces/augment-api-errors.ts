...
declare module '@polkadot/api-base/types/errors' {
  interface AugmentedErrors<ApiType extends ApiTypes> {
    ...
    ddcNodes: {
      ...
      InvalidNodePubKey: AugmentedError<ApiType>;
      NodeAlreadyExists: AugmentedError<ApiType>;
      NodeDoesNotExist: AugmentedError<ApiType>;
      NodeIsAssignedToCluster: AugmentedError<ApiType>;
      NodeParamsExceedsLimit: AugmentedError<ApiType>;
      OnlyNodeProvider: AugmentedError<ApiType>;
    };
    ddcStaking: {
      /**
       ...
       **/
      AlreadyInRole: AugmentedError<ApiType>;
      /**
       ...
       **/
      BudgetOverflow: AugmentedError<ApiType>;
      /**
       * Current era not set during runtime
       **/
      DDCEraNotSet: AugmentedError<ApiType>;
       ...
       **/
      DoubleSpendRewards: AugmentedError<ApiType>;
      /**
       * Attempt to assign reward point for some era more than once
       **/
      DuplicateRewardPoints: AugmentedError<ApiType>;
      /**
    ...
    erc721: {
       ...
       * ID not recognized
       **/
      TokenIdDoesNotExist: AugmentedError<ApiType>;
    };
    fastUnstake: {
      /**
