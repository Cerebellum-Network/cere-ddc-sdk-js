...
declare module '@polkadot/api-base/types/submittable' {
    interface AugmentedSubmittables<ApiType extends ApiTypes> {
        ...
        cereDDCModule: {
            sendData: AugmentedSubmittable<
                (
                    sendTo: AccountId32 | string | Uint8Array,
        ...
        contracts: {
            ...
            call: AugmentedSubmittable<
                (
                    dest:
                        ...
                        | Uint8Array,
                    value: Compact<u128> | AnyNumber | Uint8Array,
                    gasLimit: Compact<Weight> | AnyNumber | Uint8Array,
                    storageDepositLimit: Option<Compact<u128>> | null | Uint8Array | Compact<u128> | AnyNumber,
                    data: Bytes | string | Uint8Array,
                ) => SubmittableExtrinsic<ApiType>,
                [MultiAddress, Compact<u128>, Compact<Weight>, Option<Compact<u128>>, Bytes]
            >;
            /**
            ...
            instantiate: AugmentedSubmittable<
                ...
                [Compact<u128>, Compact<Weight>, Option<Compact<u128>>, H256, Bytes, Bytes]
            >;
            /**
            ...
            instantiateWithCode: AugmentedSubmittable<
                ...
                [Compact<u128>, Compact<Weight>, Option<Compact<u128>>, Bytes, Bytes, Bytes]
            >;
            /**
        ...
        ddcClusters: {
            ...
            >;
            createCluster: AugmentedSubmittable<
                (
                    clusterId: H160 | string | Uint8Array,
                    clusterParams:
                        | PalletDdcClustersClusterClusterParams
                        | {params?: any; nodeProviderAuthContract?: any}
                        | string
                        | Uint8Array,
                ) => SubmittableExtrinsic<ApiType>,
        ...
        ddcCustomers: {
             ...
             * Emits `Deposited`.
             **/
            depositExtra: AugmentedSubmittable<
             ...
             **/
            unlockDeposit: AugmentedSubmittable<
                (value: Compact<u128> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>,
                [Compact<u128>]
            >;
            /**
        ...
        ddcNodes: {
            createNode: AugmentedSubmittable<
                ...
                [DdcPrimitivesNodePubKey, PalletDdcNodesNodeNodeParams]
            >;
            deleteNode: AugmentedSubmittable<
                (
                    nodePubKey: DdcPrimitivesNodePubKey | {StoragePubKey: any} | {CDNPubKey: any} | string | Uint8Array,
                ) => SubmittableExtrinsic<ApiType>,
                [DdcPrimitivesNodePubKey]
            >;
            setNodeParams: AugmentedSubmittable<
                (
                    nodePubKey: DdcPrimitivesNodePubKey | {StoragePubKey: any} | {CDNPubKey: any} | string | Uint8Array,
                    nodeParams:
                        | PalletDdcNodesNodeNodeParams
        ...
        ddcStaking: {
             ...
             **/
            allowClusterManager: AugmentedSubmittable<
                (
                    grantee:
                        | MultiAddress
                        | {Id: any}
            ...
            bond: AugmentedSubmittable<
                ...
                [MultiAddress, DdcPrimitivesNodePubKey, Compact<u128>]
            >;
            /**
             ...
             * RuntimeOrigin must be Root to call this function.
             **/
            disallowClusterManager: AugmentedSubmittable<
                (
                    revokee:
                        | MultiAddress
                        | {Id: any}
            ...
            payoutStakers: AugmentedSubmittable<
                (era: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>,
                [u32]
            >;
            /**
             ...
             * The dispatch origin for this call must be _Signed_ by the stash, not the controller.
             **/
            setNode: AugmentedSubmittable<
                (
                    newNode: DdcPrimitivesNodePubKey | {StoragePubKey: any} | {CDNPubKey: any} | string | Uint8Array,
                ) => SubmittableExtrinsic<ApiType>,
                [DdcPrimitivesNodePubKey]
            >;
            /**
             ...
             **/
            setPricing: AugmentedSubmittable<
                (pricePerByte: u128 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>,
                [u128]
            >;
            /**
             ...
             * settings update.
             **/
            setSettings: AugmentedSubmittable<
                (
                    cluster: H160 | string | Uint8Array,
                    settings:
                        | Option<PalletDdcStakingClusterSettings>
                        | null
                        | Uint8Array
                        | PalletDdcStakingClusterSettings
                        | {edgeBondSize?: any; edgeChillDelay?: any; storageBondSize?: any; storageChillDelay?: any}
                        | string,
                ) => SubmittableExtrinsic<ApiType>,
                [H160, Option<PalletDdcStakingClusterSettings>]
            >;
            /**
        ...
        erc20: {
             ...
             **/
            mintErc721: AugmentedSubmittable<
                (
                    recipient: AccountId32 | string | Uint8Array,
                    id: U256 | AnyNumber | Uint8Array,
                    metadata: Bytes | string | Uint8Array,
                ) => SubmittableExtrinsic<ApiType>,
                [AccountId32, U256, Bytes]
            >;
            /**
             ...
             **/
            transferErc721: AugmentedSubmittable<
                (
                    recipient: Bytes | string | Uint8Array,
                    tokenId: U256 | AnyNumber | Uint8Array,
             ...
             **/
            transferHash: AugmentedSubmittable<
                (
        ...
        fastUnstake: {
            ...
            control: AugmentedSubmittable<
                (uncheckedErasToCheck: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>,
                [u32]
            >;
            /**
        ...
        multisig: {
            ...
            approveAsMulti: AugmentedSubmittable<
                ...
                [u16, Vec<AccountId32>, Option<PalletMultisigTimepoint>, U8aFixed, Weight]
            >;
            /**
             * Register approval for a dispatch to be made from a deterministic composite account if
             * approved by a total of `threshold - 1` of `other_signatories`.
            ...
            asMulti: AugmentedSubmittable<
                ...
                [u16, Vec<AccountId32>, Option<PalletMultisigTimepoint>, WrapperKeepOpaque<Call>, bool, Weight]
            >;
            /**
        ...
        nominationPools: {
            ...
            bondExtra: AugmentedSubmittable<
                (
                    extra: PalletNominationPoolsBondExtra | {FreeBalance: any} | {Rewards: any} | string | Uint8Array,
                ) => SubmittableExtrinsic<ApiType>,
                [PalletNominationPoolsBondExtra]
            >;
            /**
        ...
        proxy: {
            ...
            addProxy: AugmentedSubmittable<
                ...
                [MultiAddress, CereDevRuntimeProxyType, u32]
            >;
            /**
            ...
            createPure: AugmentedSubmittable<
                ...
                [CereDevRuntimeProxyType, u32, u16]
            >;
            /**
            ...
            killPure: AugmentedSubmittable<
                ...
                [MultiAddress, CereDevRuntimeProxyType, u16, Compact<u32>, Compact<u32>]
            >;
            /**
            ...
            proxy: AugmentedSubmittable<
                (
                    real:
                        ...
                        | Uint8Array,
                    forceProxyType:
                        | Option<CereDevRuntimeProxyType>
                        | null
                        | Uint8Array
                        | CereDevRuntimeProxyType
                        | 'Any'
                ...
                [MultiAddress, Option<CereDevRuntimeProxyType>, Call]
            >;
            /**
            ...
            proxyAnnounced: AugmentedSubmittable<
                ...
                [MultiAddress, MultiAddress, Option<CereDevRuntimeProxyType>, Call]
            >;
            /**
        ...
        session: {
            ...
            setKeys: AugmentedSubmittable<
                ...
                [CereDevRuntimeSessionKeys, Bytes]
            >;
        };
        society: {
            /**
        ...
        utility: {
            ...
            dispatchAs: AugmentedSubmittable<
                ...
                [CereDevRuntimeOriginCaller, Call]
            >;
            /**
             * Send a batch of dispatch calls.
