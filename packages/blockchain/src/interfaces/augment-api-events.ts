...
import type { CereDevRuntimeProxyType, DdcPrimitivesNodePubKey, FrameSupportDispatchDispatchInfo, FrameSupportScheduleLookupError, FrameSupportTokensMiscBalanceStatus, PalletDdcStakingEraRewardPoints, PalletDdcValidatorValidationDecision, PalletDemocracyVoteAccountVote, PalletDemocracyVoteThreshold, PalletElectionProviderMultiPhaseElectionCompute, PalletImOnlineSr25519AppSr25519Public, PalletMultisigTimepoint, PalletNominationPoolsPoolState, PalletStakingExposure, PalletStakingValidatorPrefs, SpFinalityGrandpaAppPublic, SpNposElectionsElectionScore, SpRuntimeDispatchError } from '@polkadot/types/lookup';
...
declare module '@polkadot/api-base/types/events' {
  interface AugmentedEvents<ApiType extends ApiTypes> {
    ...
    ddcClusters: {
      ...
      ClusterNodeAdded: AugmentedEvent<ApiType, [clusterId: H160, nodePubKey: DdcPrimitivesNodePubKey], { clusterId: H160, nodePubKey: DdcPrimitivesNodePubKey }>;
      ClusterNodeRemoved: AugmentedEvent<ApiType, [clusterId: H160, nodePubKey: DdcPrimitivesNodePubKey], { clusterId: H160, nodePubKey: DdcPrimitivesNodePubKey }>;
    ...
    ddcNodes: {
      NodeCreated: AugmentedEvent<ApiType, [nodePubKey: DdcPrimitivesNodePubKey], { nodePubKey: DdcPrimitivesNodePubKey }>;
      NodeDeleted: AugmentedEvent<ApiType, [nodePubKey: DdcPrimitivesNodePubKey], { nodePubKey: DdcPrimitivesNodePubKey }>;
      NodeParamsChanged: AugmentedEvent<ApiType, [nodePubKey: DdcPrimitivesNodePubKey], { nodePubKey: DdcPrimitivesNodePubKey }>;
    };
    ddcStaking: {
      /**
       * An account has bonded this amount. \[stash, amount\]
    ...
    proxy: {
       ...
       * A proxy was added.
       **/
      ProxyAdded: AugmentedEvent<ApiType, [delegator: AccountId32, delegatee: AccountId32, proxyType: CereDevRuntimeProxyType, delay: u32], { delegator: AccountId32, delegatee: AccountId32, proxyType: CereDevRuntimeProxyType, delay: u32 }>;
      /**
       ...
       * A proxy was removed.
       **/
      ProxyRemoved: AugmentedEvent<ApiType, [delegator: AccountId32, delegatee: AccountId32, proxyType: CereDevRuntimeProxyType, delay: u32], { delegator: AccountId32, delegatee: AccountId32, proxyType: CereDevRuntimeProxyType, delay: u32 }>;
      /**
       * A pure account has been created by new proxy with given
       * disambiguation index and proxy type.
       **/
      PureCreated: AugmentedEvent<ApiType, [pure: AccountId32, who: AccountId32, proxyType: CereDevRuntimeProxyType, disambiguationIndex: u16], { pure: AccountId32, who: AccountId32, proxyType: CereDevRuntimeProxyType, disambiguationIndex: u16 }>;
    };
    recovery: {
      /**
