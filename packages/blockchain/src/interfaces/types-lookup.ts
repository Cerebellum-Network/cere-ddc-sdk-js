...
declare module '@polkadot/types/lookup' {
  ...
  interface PalletDdcCustomersEvent extends Enum {
    ...
    readonly isBucketCreated: boolean;
    readonly asBucketCreated: u64;
    readonly type: 'Deposited' | 'InitiatDepositUnlock' | 'Withdrawn' | 'Charged' | 'BucketCreated';
  }

  /** @name PalletDdcNodesEvent (107) */
  ...
  /** @name DdcPrimitivesNodePubKey (108) */
  ...
  /** @name PalletDdcClustersEvent (109) */
  interface PalletDdcClustersEvent extends Enum {
    ...
    readonly isClusterGovParamsSet: boolean;
    readonly asClusterGovParamsSet: {
      readonly clusterId: H160;
    } & Struct;
    readonly type: 'ClusterCreated' | 'ClusterNodeAdded' | 'ClusterNodeRemoved' | 'ClusterParamsSet' | 'ClusterGovParamsSet';
  }
  ...
  /** @name CereDevRuntimeNposSolution16 (155) */
  ...
  /** @name CereDevRuntimeSessionKeys (221) */
  ...
  /** @name PalletChainbridgeCall (319) */
  ...
  /** @name PalletDdcMetricsOffchainWorkerCall (322) */
  type PalletDdcMetricsOffchainWorkerCall = Null;

  /** @name PalletDdcStakingCall (323) */
  ...
  /** @name PalletDdcCustomersCall (324) */
  interface PalletDdcCustomersCall extends Enum {
    ...
    readonly type: 'CreateBucket' | 'Deposit' | 'DepositExtra' | 'UnlockDeposit' | 'WithdrawUnlockedDeposit';
  }

  /** @name PalletDdcNodesCall (325) */
  ...
  /** @name PalletDdcNodesNodeNodeParams (326) */
  ...
  /** @name PalletDdcNodesStorageNodeStorageNodeParams (327) */
  interface PalletDdcNodesStorageNodeStorageNodeParams extends Struct {
    readonly host: Bytes;
    readonly httpPort: u16;
    readonly grpcPort: u16;
    readonly p2pPort: u16;
  }

  /** @name PalletDdcNodesCdnNodeCdnNodeParams (328) */
  ...
  /** @name PalletDdcClustersCall (329) */
  interface PalletDdcClustersCall extends Enum {
    readonly isCreateCluster: boolean;
    readonly asCreateCluster: {
      readonly clusterId: H160;
      readonly clusterManagerId: AccountId32;
      readonly clusterReserveId: AccountId32;
      readonly clusterParams: PalletDdcClustersClusterClusterParams;
      readonly clusterGovParams: PalletDdcClustersClusterClusterGovParams;
    } & Struct;
    ...
    readonly isSetClusterGovParams: boolean;
    readonly asSetClusterGovParams: {
      readonly clusterId: H160;
      readonly clusterGovParams: PalletDdcClustersClusterClusterGovParams;
    } & Struct;
    readonly type: 'CreateCluster' | 'AddNode' | 'RemoveNode' | 'SetClusterParams' | 'SetClusterGovParams';
  }

  /** @name PalletDdcClustersClusterClusterParams (330) */
  interface PalletDdcClustersClusterClusterParams extends Struct {
    readonly nodeProviderAuthContract: AccountId32;
  }

  /** @name PalletDdcClustersClusterClusterGovParams (331) */
  interface PalletDdcClustersClusterClusterGovParams extends Struct {
    readonly treasuryShare: Perbill;
    readonly validatorsShare: Perbill;
    readonly clusterReserveShare: Perbill;
    readonly cdnBondSize: u128;
    readonly cdnChillDelay: u32;
    readonly cdnUnbondingDelay: u32;
    readonly storageBondSize: u128;
    readonly storageChillDelay: u32;
    readonly storageUnbondingDelay: u32;
    readonly unitPerMbStored: u128;
    readonly unitPerMbStreamed: u128;
    readonly unitPerPutRequest: u128;
    readonly unitPerGetRequest: u128;
  }

  /** @name CereDevRuntimeOriginCaller (332) */
  ...
  /** @name SpConsensusBabeDigestsPreDigest (344) */
  ...
  /** @name SpConsensusBabeDigestsPrimaryPreDigest (345) */
  ...
  /** @name SpConsensusBabeDigestsSecondaryPlainPreDigest (346) */
  interface SpConsensusBabeDigestsSecondaryPlainPreDigest extends Struct {
    readonly authorityIndex: u32;
    readonly slot: u64;
  }

  /** @name SpConsensusBabeDigestsSecondaryVRFPreDigest (347) */
  ...
  /** @name PalletContractsWasmPrefabWasmModule (447) */
  ...
  /** @name PalletContractsWasmOwnerInfo (449) */
  ...
  /** @name PalletContractsStorageContractInfo (450) */
  ...
  /** @name PalletContractsStorageDeletedContract (453) */
  interface PalletContractsStorageDeletedContract extends Struct {
    readonly trieId: Bytes;
  }

  /** @name PalletContractsSchedule (455) */
  ...
  /** @name PalletContractsScheduleLimits (456) */
  ...
  /** @name PalletContractsScheduleInstructionWeights (457) */
  ...
  /** @name PalletContractsScheduleHostFnWeights (458) */
  ...
  /** @name PalletImOnlineBoundedOpaqueNetworkState (464) */
  interface PalletImOnlineBoundedOpaqueNetworkState extends Struct {
    readonly peerId: Bytes;
    readonly externalAddresses: Vec<Bytes>;
  }

  /** @name PalletImOnlineError (468) */
  ...
  /** @name SpStakingOffenceOffenceDetails (471) */
  ...
  /** @name PalletIdentityRegistrarInfo (482) */
  ...
  /** @name PalletSocietyVouchingStatus (489) */
  ...
  /** @name PalletRecoveryRecoveryConfig (495) */
  ...
  /** @name PalletRecoveryActiveRecovery (497) */
  ...
  /** @name PalletVestingReleases (501) */
  ...
  /** @name PalletSchedulerScheduledV3 (505) */
  ...
  /** @name PalletProxyProxyDefinition (509) */
  ...
  /** @name PalletProxyAnnouncement (513) */
  ...
  /** @name PalletBagsListListNode (526) */
  ...
  /** @name PalletBagsListListBag (527) */
  interface PalletBagsListListBag extends Struct {
    readonly head: Option<AccountId32>;
    readonly tail: Option<AccountId32>;
  }

  /** @name PalletBagsListError (529) */
  ...
  /** @name PalletBagsListListListError (530) */
  ...
  /** @name PalletChildBountiesChildBounty (531) */
  ...
  /** @name PalletChildBountiesChildBountyStatus (532) */
  ...
  /** @name PalletChildBountiesError (533) */
  ...
  /** @name PalletNominationPoolsPoolMember (534) */
  ...
  /** @name PalletNominationPoolsBondedPoolInner (537) */
  ...
  /** @name PalletNominationPoolsPoolRoles (538) */
  ...
  /** @name PalletNominationPoolsRewardPool (539) */
  ...
  /** @name PalletNominationPoolsSubPools (540) */
  ...
  /** @name PalletNominationPoolsUnbondPool (541) */
  interface PalletNominationPoolsUnbondPool extends Struct {
    readonly points: u128;
    readonly balance: u128;
  }

  /** @name PalletNominationPoolsError (547) */
  ...
  /** @name PalletNominationPoolsDefensiveError (548) */
  ...
  /** @name PalletFastUnstakeUnstakeRequest (549) */
  ...
  /** @name PalletFastUnstakeMaxChecking (550) */
  type PalletFastUnstakeMaxChecking = Null;

  /** @name PalletFastUnstakeError (552) */
  ...
  /** @name PalletChainbridgeProposalVotes (556) */
  ...
  /** @name PalletChainbridgeProposalStatus (557) */
  ...
  /** @name PalletChainbridgeError (558) */
  ...
  /** @name PalletErc721Erc721Token (559) */
  interface PalletErc721Erc721Token extends Struct {
    readonly id: U256;
    readonly metadata: Bytes;
  }

  /** @name PalletErc721Error (560) */
  ...
  /** @name PalletDdcStakingStakingLedger (561) */
  ...
  /** @name PalletDdcStakingUnlockChunk (563) */
  interface PalletDdcStakingUnlockChunk extends Struct {
    readonly value: Compact<u128>;
    readonly block: Compact<u32>;
  }

  /** @name PalletDdcStakingError (565) */
  ...
  interface PalletDdcCustomersError extends Enum {
    ...
    readonly type: 'NotOwner' | 'NotBucketOwner' | 'AlreadyPaired' | 'InsufficientDeposit' | 'NoMoreChunks' | 'NoBucketWithId' | 'BadState' | 'BucketDoesNotExist' | 'ClusterDoesNotExist';
  }

  /** @name PalletDdcNodesStorageNode (572) */
  ...
  /** @name PalletDdcNodesStorageNodeStorageNodeProps (574) */
  ...
  /** @name PalletDdcNodesCdnNode (576) */
  ...
  /** @name PalletDdcNodesCdnNodeCdnNodeProps (577) */
  ...
  interface PalletDdcNodesError extends Enum {
    ...
    readonly isHostLenExceedsLimit: boolean;
    readonly type: 'NodeAlreadyExists' | 'NodeDoesNotExist' | 'InvalidNodePubKey' | 'InvalidNodeParams' | 'NodeParamsExceedsLimit' | 'OnlyNodeProvider' | 'NodeIsAssignedToCluster' | 'HostLenExceedsLimit';
  }

  /** @name PalletDdcClustersCluster (580) */
  interface PalletDdcClustersCluster extends Struct {
    readonly clusterId: H160;
    readonly managerId: AccountId32;
    readonly reserveId: AccountId32;
    readonly props: PalletDdcClustersClusterClusterProps;
  }

  /** @name PalletDdcClustersClusterClusterProps (581) */
  interface PalletDdcClustersClusterClusterProps extends Struct {
    readonly nodeProviderAuthContract: AccountId32;
  }

  /** @name PalletDdcClustersError (583) */
  interface PalletDdcClustersError extends Enum {
    ...
    readonly isNodeIsNotAuthorized: boolean;
    readonly isNodeHasNoStake: boolean;
    readonly isNodeStakeIsInvalid: boolean;
    readonly isNodeChillingIsProhibited: boolean;
    readonly isNodeAuthContractCallFailed: boolean;
    readonly type: 'ClusterAlreadyExists' | 'ClusterDoesNotExist' | 'ClusterParamsExceedsLimit' | 'AttemptToAddNonExistentNode' | 'AttemptToRemoveNonExistentNode' | 'NodeIsAlreadyAssigned' | 'NodeIsNotAssigned' | 'OnlyClusterManager' | 'NodeIsNotAuthorized' | 'NodeHasNoStake' | 'NodeStakeIsInvalid' | 'NodeChillingIsProhibited' | 'NodeAuthContractCallFailed';
  }
  ...
  /** @name CereDevRuntimeRuntime (598) */
