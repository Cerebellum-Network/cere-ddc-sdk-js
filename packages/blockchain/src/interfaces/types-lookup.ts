...
declare module '@polkadot/types/lookup' {
  ...
  /** @name PalletDdcAccountsEvent (114) */
  interface PalletDdcAccountsEvent extends Enum {
    ...
    readonly type: 'Deposited' | 'Unbonded' | 'Withdrawn' | 'Charged';
  }
  ...
  interface PalletDdcStakingCall extends Enum {
    ...
    readonly type: 'Bond' | 'Unbond' | 'WithdrawUnbonded' | 'Serve' | 'Store' | 'Chill' | 'SetController' | 'SetSettings' | 'PayoutStakers' | 'SetPricing' | 'AllowClusterManager' | 'DisallowClusterManager' | 'SetNode';
  }
  ...
  interface PalletDdcValidatorCall extends Enum {
    ...
    readonly asChargePaymentsContentOwners: {
      readonly payingAccounts: Vec<PalletDdcAccountsBucketsDetails>;
    } & Struct;
    readonly isSetValidatorKey: boolean;
    readonly asSetValidatorKey: {
      readonly ddcValidatorPub: AccountId32;
    } & Struct;
    readonly type: 'SendSignal' | 'SetValidationDecision' | 'SetEraRewardPoints' | 'ChargePaymentsContentOwners' | 'SetValidatorKey';
  }

  /** @name PalletDdcAccountsBucketsDetails (335) */
  interface PalletDdcAccountsBucketsDetails extends Struct {
    readonly bucketId: u128;
    readonly amount: u128;
  }

  /** @name PalletDdcAccountsCall (336) */
  interface PalletDdcAccountsCall extends Enum {
    ...
    readonly isWithdrawUnbonded: boolean;
    readonly type: 'CreateBucket' | 'Deposit' | 'DepositExtra' | 'Unbond' | 'WithdrawUnbonded';
  }
  ...
  interface PalletDdcClustersCall extends Enum {
    ...
    readonly type: 'CreateCluster' | 'AddNode' | 'RemoveNode' | 'SetClusterParams';
  }
  ...
  interface PalletDdcStakingError extends Enum {
    ...
    readonly type: 'NotController' | 'NotStash' | 'AlreadyBonded' | 'AlreadyPaired' | 'InsufficientBond' | 'NoMoreChunks' | 'BadState' | 'AlreadyInRole' | 'TooEarly' | 'EraNotValidated' | 'DuplicateRewardPoints' | 'DoubleSpendRewards' | 'PricingNotSet' | 'BudgetOverflow' | 'DdcEraNotSet';
  }
  ...
  interface PalletDdcValidatorError extends Enum {
    ...
    readonly isPricingNotSet: boolean;
    readonly isDdcEraNotSet: boolean;
    readonly type: 'NotController' | 'NotValidatorStash' | 'DdcValidatorKeyNotRegistered' | 'ContentOwnersDoubleSpend' | 'ValidationDecisionAlreadySet' | 'NodeNotActive' | 'PricingNotSet' | 'DdcEraNotSet';
  }

  /** @name PalletDdcAccountsAccountsLedger (582) */
  interface PalletDdcAccountsAccountsLedger extends Struct {
    readonly stash: AccountId32;
    readonly total: Compact<u128>;
    readonly active: Compact<u128>;
    readonly unlocking: Vec<PalletDdcAccountsUnlockChunk>;
  }

  /** @name PalletDdcAccountsUnlockChunk (584) */
  interface PalletDdcAccountsUnlockChunk extends Struct {
    readonly value: Compact<u128>;
    readonly era: Compact<u32>;
  }

  /** @name PalletDdcAccountsBucket (586) */
  interface PalletDdcAccountsBucket extends Struct {
    readonly bucketId: u128;
  ...
  /** @name PalletDdcAccountsError (587) */
  interface PalletDdcAccountsError extends Enum {
    readonly isNotController: boolean;
    readonly isNotStash: boolean;
    readonly isAlreadyBonded: boolean;
    readonly isAlreadyPaired: boolean;
    ...
    readonly type: 'NotController' | 'NotStash' | 'AlreadyBonded' | 'AlreadyPaired' | 'InsufficientDeposit' | 'NoMoreChunks' | 'BadState' | 'DdcEraNotSet' | 'BucketDoesNotExist';
  }

  /** @name PalletDdcNodesStorageNode (588) */
  ...
  interface PalletDdcNodesError extends Enum {
    ...
    readonly type: 'NodeAlreadyExists' | 'NodeDoesNotExist' | 'InvalidNodePubKey' | 'InvalidNodeParams' | 'NodeParamsExceedsLimit' | 'OnlyNodeProvider' | 'NodeIsAssignedToCluster';
  }
  ...
  interface PalletDdcClustersError extends Enum {
    ...
    readonly type: 'ClusterAlreadyExists' | 'ClusterDoesNotExist' | 'ClusterParamsExceedsLimit' | 'AttemptToAddNonExistentNode' | 'AttemptToRemoveNonExistentNode' | 'NodeIsAlreadyAssigned' | 'NodeIsNotAssigned' | 'OnlyClusterManager' | 'NotAuthorized' | 'NoStake';
  }
