...
declare module '@polkadot/types/types/registry' {
  interface InterfaceTypes {
    ...
    PalletDdcClustersClusterClusterGovParams: PalletDdcClustersClusterClusterGovParams;
