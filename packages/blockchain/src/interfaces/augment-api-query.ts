...
import type { BTreeMap, Bytes, Option, U256, U8aFixed, Vec, WrapperKeepOpaque, WrapperOpaque, bool, u128, u32, u64, u8 } from '@polkadot/types-codec';
import type { AnyNumber, IMethod, ITuple } from '@polkadot/types-codec/types';
import type { AccountId32, Call, H160, H256, Perbill, Percent } from '@polkadot/types/interfaces/runtime';
import type { CereDevRuntimeSessionKeys, DdcPrimitivesNodePubKey, FrameSupportDispatchPerDispatchClassWeight, FrameSystemAccountInfo, FrameSystemEventRecord, FrameSystemLastRuntimeUpgradeInfo, FrameSystemPhase, PalletAuthorshipUncleEntryItem, PalletBagsListListBag, PalletBagsListListNode, PalletBalancesAccountData, PalletBalancesBalanceLock, PalletBalancesReleases, PalletBalancesReserveData, PalletBountiesBounty, PalletChainbridgeProposalVotes, PalletChildBountiesChildBounty, PalletCollectiveVotes, PalletContractsStorageContractInfo, PalletContractsStorageDeletedContract, PalletContractsWasmOwnerInfo, PalletContractsWasmPrefabWasmModule, PalletDdcAccountsAccountsLedger, PalletDdcAccountsBucket, PalletDdcClustersCluster, PalletDdcNodesCdnNode, PalletDdcNodesStorageNode, PalletDdcStakingClusterSettings, PalletDdcStakingEraRewardPoints, PalletDdcStakingEraRewardPointsPerNode, PalletDdcStakingEraRewardsPaid, PalletDdcStakingStakingLedger, PalletDdcValidatorValidationDecision, PalletDemocracyPreimageStatus, PalletDemocracyReferendumInfo, PalletDemocracyReleases, PalletDemocracyVoteThreshold, PalletDemocracyVoteVoting, PalletElectionProviderMultiPhasePhase, PalletElectionProviderMultiPhaseReadySolution, PalletElectionProviderMultiPhaseRoundSnapshot, PalletElectionProviderMultiPhaseSignedSignedSubmission, PalletElectionProviderMultiPhaseSolutionOrSnapshotSize, PalletElectionsPhragmenSeatHolder, PalletElectionsPhragmenVoter, PalletErc721Erc721Token, PalletFastUnstakeUnstakeRequest, PalletGrandpaStoredPendingChange, PalletGrandpaStoredState, PalletIdentityRegistrarInfo, PalletIdentityRegistration, PalletImOnlineBoundedOpaqueNetworkState, PalletImOnlineSr25519AppSr25519Public, PalletMultisigMultisig, PalletNominationPoolsBondedPoolInner, PalletNominationPoolsPoolMember, PalletNominationPoolsRewardPool, PalletNominationPoolsSubPools, PalletProxyAnnouncement, PalletProxyProxyDefinition, PalletRecoveryActiveRecovery, PalletRecoveryRecoveryConfig, PalletSchedulerScheduledV3, PalletSocietyBid, PalletSocietyBidKind, PalletSocietyVote, PalletSocietyVouchingStatus, PalletStakingActiveEraInfo, PalletStakingEraRewardPoints, PalletStakingExposure, PalletStakingForcing, PalletStakingNominations, PalletStakingReleases, PalletStakingRewardDestination, PalletStakingSlashingSlashingSpans, PalletStakingSlashingSpanRecord, PalletStakingStakingLedger, PalletStakingUnappliedSlash, PalletStakingValidatorPrefs, PalletTipsOpenTip, PalletTransactionPaymentReleases, PalletTreasuryProposal, PalletVestingReleases, PalletVestingVestingInfo, SpAuthorityDiscoveryAppPublic, SpConsensusBabeAppPublic, SpConsensusBabeBabeEpochConfiguration, SpConsensusBabeDigestsNextConfigDescriptor, SpConsensusBabeDigestsPreDigest, SpCoreCryptoKeyTypeId, SpNposElectionsElectionScore, SpRuntimeDigest, SpStakingOffenceOffenceDetails } from '@polkadot/types/lookup';
...
declare module '@polkadot/api-base/types/storage' {
  interface AugmentedQueries<ApiType extends ApiTypes> {
    ...
    cereDDCModule: {
       ...
       **/
      stringDataOf: AugmentedQuery<ApiType, (arg: AccountId32 | string | Uint8Array) => Observable<Option<Bytes>>, [AccountId32]>;
    };
    chainBridge: {
      /**
       ...
       **/
      votes: AugmentedQuery<ApiType, (arg1: u8 | AnyNumber | Uint8Array, arg2: ITuple<[u64, Call]> | [u64 | AnyNumber | Uint8Array, Call | IMethod | string | Uint8Array]) => Observable<Option<PalletChainbridgeProposalVotes>>, [u8, ITuple<[u64, Call]>]>;
    };
    childBounties: {
      /**
    ...
    ddcAccounts: {
       ...
       **/
      buckets: AugmentedQuery<ApiType, (arg: u128 | AnyNumber | Uint8Array) => Observable<Option<PalletDdcAccountsBucket>>, [u128]>;
      bucketsCount: AugmentedQuery<ApiType, () => Observable<u128>, []>;
      /**
       * Map from all (unlocked) "controller" accounts to the info regarding the staking.
       **/
      ledger: AugmentedQuery<ApiType, (arg: AccountId32 | string | Uint8Array) => Observable<Option<PalletDdcAccountsAccountsLedger>>, [AccountId32]>;
    };
    ddcClusters: {
      clusters: AugmentedQuery<ApiType, (arg: H160 | string | Uint8Array) => Observable<Option<PalletDdcClustersCluster>>, [H160]>;
      clustersNodes: AugmentedQuery<ApiType, (arg1: H160 | string | Uint8Array, arg2: DdcPrimitivesNodePubKey | { StoragePubKey: any } | { CDNPubKey: any } | string | Uint8Array) => Observable<bool>, [H160, DdcPrimitivesNodePubKey]>;
    };
    ddcMetricsOffchainWorker: {
    };
    ddcNodes: {
      cdnNodes: AugmentedQuery<ApiType, (arg: AccountId32 | string | Uint8Array) => Observable<Option<PalletDdcNodesCdnNode>>, [AccountId32]>;
      storageNodes: AugmentedQuery<ApiType, (arg: AccountId32 | string | Uint8Array) => Observable<Option<PalletDdcNodesStorageNode>>, [AccountId32]>;
    };
    ddcStaking: {
      /**
       * Map from all locked "stash" accounts to the controller account.
       ...
       **/
      clusterManagers: AugmentedQuery<ApiType, () => Observable<Vec<AccountId32>>, []>;
      /**
       ...
       * participate into.
       **/
      edges: AugmentedQuery<ApiType, (arg: AccountId32 | string | Uint8Array) => Observable<Option<H160>>, [AccountId32]>;
      /**
       ...
       **/
      erasEdgesRewardPoints: AugmentedQuery<ApiType, (arg: u32 | AnyNumber | Uint8Array) => Observable<PalletDdcStakingEraRewardPoints>, [u32]>;
      /**
       * The reward each CDN participant earned in the era.
       ...
       **/
      erasEdgesRewardPointsPerNode: AugmentedQuery<ApiType, (arg: AccountId32 | string | Uint8Array) => Observable<Vec<PalletDdcStakingEraRewardPointsPerNode>>, [AccountId32]>;
      /**
       * Map from all (unlocked) "controller" accounts to the info regarding the staking.
       **/
      ledger: AugmentedQuery<ApiType, (arg: AccountId32 | string | Uint8Array) => Observable<Option<PalletDdcStakingStakingLedger>>, [AccountId32]>;
      /**
       * Map from DDC node ID to the node operator stash account.
       **/
      nodes: AugmentedQuery<ApiType, (arg: DdcPrimitivesNodePubKey | { StoragePubKey: any } | { CDNPubKey: any } | string | Uint8Array) => Observable<Option<AccountId32>>, [DdcPrimitivesNodePubKey]>;
      /**
       * Map to check if CDN participants received payments for specific era
       * 
       * Used to avoid double-spend in method [payout_stakers]
       **/
      paidEras: AugmentedQuery<ApiType, (arg: u32 | AnyNumber | Uint8Array) => Observable<bool>, [u32]>;
      /**
       * Map from all "stash" accounts to the paid out rewards per era
       * 
       * P.S. Not part of Mainnet
       **/
      paidErasPerNode: AugmentedQuery<ApiType, (arg: AccountId32 | string | Uint8Array) => Observable<Vec<PalletDdcStakingEraRewardsPaid>>, [AccountId32]>;
      /**
       * Price per byte of the bucket traffic in smallest units of the currency.
       **/
      pricing: AugmentedQuery<ApiType, () => Observable<Option<u128>>, []>;
      /**
       ...
       **/
      settings: AugmentedQuery<ApiType, (arg: H160 | string | Uint8Array) => Observable<PalletDdcStakingClusterSettings>, [H160]>;
      /**
       * The map of (wannabe) storage network participants stash keys to the DDC cluster ID they wish
       * to participate into.
       **/
      storages: AugmentedQuery<ApiType, (arg: AccountId32 | string | Uint8Array) => Observable<Option<H160>>, [AccountId32]>;
    };
    ddcValidator: {
      /**
       * The map from the era and validator stash key to the list of CDN nodes to validate.
       **/
      assignments: AugmentedQuery<ApiType, (arg1: u32 | AnyNumber | Uint8Array, arg2: AccountId32 | string | Uint8Array) => Observable<Option<Vec<AccountId32>>>, [u32, AccountId32]>;
      /**
       ...
       **/
      ddcValidatorToStashKeys: AugmentedQuery<ApiType, (arg: AccountId32 | string | Uint8Array) => Observable<Option<AccountId32>>, [AccountId32]>;
      /**
       * Map to from era and account ID to bool indicateing that a particular content owner was
       * charged for the era
       **/
      eraContentOwnersCharged: AugmentedQuery<ApiType, (arg1: u32 | AnyNumber | Uint8Array, arg2: AccountId32 | string | Uint8Array) => Observable<bool>, [u32, AccountId32]>;
      /**
       * The last era for which the tasks assignment produced.
       **/
      lastManagedEra: AugmentedQuery<ApiType, () => Observable<Option<u32>>, []>;
      rewardPointsSetForNode: AugmentedQuery<ApiType, (arg1: u32 | AnyNumber | Uint8Array, arg2: AccountId32 | string | Uint8Array) => Observable<bool>, [u32, AccountId32]>;
      /**
       ...
       **/
      validationDecisions: AugmentedQuery<ApiType, (arg1: u32 | AnyNumber | Uint8Array, arg2: AccountId32 | string | Uint8Array) => Observable<Option<PalletDdcValidatorValidationDecision>>, [u32, AccountId32]>;
      validationDecisionSetForNode: AugmentedQuery<ApiType, (arg1: u32 | AnyNumber | Uint8Array, arg2: AccountId32 | string | Uint8Array) => Observable<bool>, [u32, AccountId32]>;
    };
    democracy: {
      /**
    ...
    erc721: {
       ...
       **/
      tokenOwner: AugmentedQuery<ApiType, (arg: U256 | AnyNumber | Uint8Array) => Observable<Option<AccountId32>>, [U256]>;
      /**
       * Maps tokenId to Erc721 object
       **/
      tokens: AugmentedQuery<ApiType, (arg: U256 | AnyNumber | Uint8Array) => Observable<Option<PalletErc721Erc721Token>>, [U256]>;
    };
    fastUnstake: {
      /**
    ...
    session: {
       ...
       **/
      nextKeys: AugmentedQuery<ApiType, (arg: AccountId32 | string | Uint8Array) => Observable<Option<CereDevRuntimeSessionKeys>>, [AccountId32]>;
      /**
       ...
       **/
      queuedKeys: AugmentedQuery<ApiType, () => Observable<Vec<ITuple<[AccountId32, CereDevRuntimeSessionKeys]>>>, []>;
      /**
