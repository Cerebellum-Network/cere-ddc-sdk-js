...
declare module '@polkadot/api-base/types/storage' {
    interface AugmentedQueries<ApiType extends ApiTypes> {
        ...
        ddcStaking: {
             ...
             **/
            erasEdgesRewardPoints: AugmentedQuery<
                ApiType,
                (arg: u32 | AnyNumber | Uint8Array) => Observable<PalletDdcStakingEraRewardPoints>,
                [u32]
            >;
            /**
             * The reward each CDN participant earned in the era.
             ...
             **/
            erasEdgesRewardPointsPerNode: AugmentedQuery<
                ApiType,
                (arg: AccountId32 | string | Uint8Array) => Observable<Vec<PalletDdcStakingEraRewardPointsPerNode>>,
                [AccountId32]
            >;
            /**
             ...
             * P.S. Not part of Mainnet
             **/
            paidErasPerNode: AugmentedQuery<
                ApiType,
                (arg: AccountId32 | string | Uint8Array) => Observable<Vec<PalletDdcStakingEraRewardsPaid>>,
                [AccountId32]
            >;
            /**
             ...
             **/
            settings: AugmentedQuery<
                ApiType,
                (arg: H160 | string | Uint8Array) => Observable<PalletDdcStakingClusterSettings>,
                [H160]
            >;
            /**
