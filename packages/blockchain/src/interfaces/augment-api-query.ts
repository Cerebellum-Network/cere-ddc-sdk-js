...
declare module '@polkadot/api-base/types/storage' {
  interface AugmentedQueries<ApiType extends ApiTypes> {
    ...
    ddcClusters: {
      ...
      clustersGovParams: AugmentedQuery<ApiType, (arg: H160 | string | Uint8Array) => Observable<Option<PalletDdcClustersClusterClusterGovParams>>, [H160]>;
      clustersNodes: AugmentedQuery<ApiType, (arg1: H160 | string | Uint8Array, arg2: DdcPrimitivesNodePubKey | { StoragePubKey: any } | { CDNPubKey: any } | string | Uint8Array) => Observable<Option<bool>>, [H160, DdcPrimitivesNodePubKey]>;
    };
    ddcCustomers: {
      /**
       * Map from bucket ID to to the bucket structure
       **/
      buckets: AugmentedQuery<ApiType, (arg: u64 | AnyNumber | Uint8Array) => Observable<Option<PalletDdcCustomersBucket>>, [u64]>;
      bucketsCount: AugmentedQuery<ApiType, () => Observable<u64>, []>;
      /**
       * Map from all (unlocked) "owner" accounts to the info regarding the staking.
       **/
      ledger: AugmentedQuery<ApiType, (arg: AccountId32 | string | Uint8Array) => Observable<Option<PalletDdcCustomersAccountsLedger>>, [AccountId32]>;
    };
    ...
    ddcStaking: {
       ...
       * participate into.
       **/
      cdNs: AugmentedQuery<ApiType, (arg: AccountId32 | string | Uint8Array) => Observable<Option<H160>>, [AccountId32]>;
      /**
       ...
       **/
      providers: AugmentedQuery<ApiType, (arg: AccountId32 | string | Uint8Array) => Observable<Option<DdcPrimitivesNodePubKey>>, [AccountId32]>;
      /**
