...
The member who is retracting the proposal.

##### nodePublicKey?

`string`

The public key of the node provider. Needed in case the member is ClusterMember.NodeProvider.
...
The new protocol parameters.

##### member

`ClusterMember`

The member who is creating the proposal.
