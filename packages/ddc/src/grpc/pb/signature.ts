...
// @generated from protobuf file "pb/signature.proto" (syntax proto3)
// tslint:disable
...
/**
 * @generated from protobuf message Signature
 */
export interface Signature {
    /**
     * @generated from protobuf field: Signature.Algorithm algorithm = 1;
     */
...
/**
 * @generated from protobuf enum Signature.Algorithm
 */
...
class Signature$Type extends MessageType<Signature> {
    constructor() {
        super("Signature", [
            { no: 1, name: "algorithm", kind: "enum", T: () => ["Signature.Algorithm", Signature_Algorithm] },
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: Signature): Signature {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* Signature.Algorithm algorithm */ 1:
    ...
    internalBinaryWrite(message: Signature, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* Signature.Algorithm algorithm = 1; */
...
/**
 * @generated MessageType for protobuf message Signature
 */
