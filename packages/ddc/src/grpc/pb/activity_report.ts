...
// @generated from protobuf file "pb/activity_report.proto" (package "pb", syntax proto3)
// tslint:disable
...
/**
 * @generated from protobuf message pb.ActivityRecord
 */
export interface ActivityRecord {
    /**
     * @generated from protobuf field: pb.ActivityFulfillment upstream = 1;
     */
    upstream?: ActivityFulfillment;
    /**
     * @generated from protobuf field: repeated pb.ActivityFulfillment downstream = 2;
     */
    ...
    timestamp: number;
    /**
     * @generated from protobuf field: Signature signature = 4;
     */
    signature?: Signature;
}
/**
 * @generated from protobuf message pb.ActivityRequest
 */
export interface ActivityRequest {
    /**
     * @generated from protobuf field: optional pb.ActivityRequest parentRequest = 1;
     */
    ...
    requestId: string;
    /**
     * @generated from protobuf field: pb.ActivityRequest.RequestType requestType = 3;
     */
    requestType: ActivityRequest_RequestType;
    /**
     * @generated from protobuf field: pb.ActivityRequest.ContentType contentType = 4;
     */
    ...
    timestamp: number;
    /**
     * @generated from protobuf field: Signature signature = 10;
     */
    signature?: Signature;
}
/**
 * @generated from protobuf enum pb.ActivityRequest.RequestType
 */
...
/**
 * @generated from protobuf enum pb.ActivityRequest.ContentType
 */
...
/**
 * @generated from protobuf message pb.ActivityAcknowledgment
 */
...
/**
 * @generated from protobuf message pb.ActivityFulfillment
 */
export interface ActivityFulfillment {
    /**
     * @generated from protobuf field: pb.ActivityRequest request = 1;
     */
    request?: ActivityRequest;
    /**
     * @generated from protobuf field: optional pb.ActivityAcknowledgment ack = 2;
     */
...
class ActivityRecord$Type extends MessageType<ActivityRecord> {
    ...
    create(value?: PartialMessage<ActivityRecord>): ActivityRecord {
        const message = { downstream: [], timestamp: 0 };
...
class ActivityRequest$Type extends MessageType<ActivityRequest> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ActivityRequest): ActivityRequest {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* optional pb.ActivityRequest parentRequest */ 1:
                ...
                case /* string requestId */ 2:
                    ...
                    break;
                case /* pb.ActivityRequest.RequestType requestType */ 3:
    ...
    internalBinaryWrite(message: ActivityRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* optional pb.ActivityRequest parentRequest = 1; */
        ...
        /* pb.ActivityRequest.RequestType requestType = 3; */
...
/**
 * @generated MessageType for protobuf message pb.ActivityRequest
 */
...
class ActivityAcknowledgment$Type extends MessageType<ActivityAcknowledgment> {
    constructor() {
        super("pb.ActivityAcknowledgment", [
    ...
    create(value?: PartialMessage<ActivityAcknowledgment>): ActivityAcknowledgment {
        const message = { requestId: "", bytesStoredOrDelivered: 0, timestamp: 0 };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
...
/**
 * @generated MessageType for protobuf message pb.ActivityAcknowledgment
 */
...
/**
 * @generated MessageType for protobuf message pb.ActivityFulfillment
 */
